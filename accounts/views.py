        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    #getting cart item from user to access his variations 
...
def edit_profile(request):
    ...
    if request.method == "POST":
        ...
        user_profileform = UserProfileForm(request.POST, request.FILES, instance=userprofile)
        ...
        user_profileform=UserProfileForm(instance=userprofile)
    context={
        'user_form':user_form,
...
def change_password(request):
    if request.method == "POST":
        current_passwod = request.POST['current_password']
        ...
        if new_password==confirm_password:
            success = user.check_password(current_passwod)
            if success:
